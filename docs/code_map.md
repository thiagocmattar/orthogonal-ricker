...
| `a1_lr_screen.py` | Exact eleven-run A1 cohort, fixed-horizon LR selection, table/curve rendering, and deterministic suite provenance | The reviewed A1 evidence pins, selection presentation, or appendix output changes |
