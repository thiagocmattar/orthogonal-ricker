...
| `DESIGN-07` | open | A2 post-hoc clipping evidence | Review the exact six-source, joint `[a, m, h, q_post, k_post, v]`, five-cutoff clipping design and its descriptive claim boundary | Explicit user approval of one committed review candidate; restore reviewed manifest scope before materializing diagnostic `020` |
