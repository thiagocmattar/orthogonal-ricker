...
| --- | --- | --- |
| A1 | complete | The predeclared eight-cell rule freezes [`lr_14m=6.4e-2`](decisions.md) from config `008-a1-lr-6p4e-2`, run `001-20260826-190546-4df1c441`, checkpoint [`checkpoints/final`](../../experiments/01-a1-lr-screen/raw/008-a1-lr-6p4e-2/001-20260826-190546-4df1c441/checkpoints/final/). Exact outputs: [curve](../../experiments/01-a1-lr-screen/figs/01-a1-learning-rate-screen.pdf), [table](../../experiments/01-a1-lr-screen/figs/01-a1-learning-rate-screen.md), and [provenance](../../experiments/01-a1-lr-screen/figs/01-a1-learning-rate-screen.provenance.json), generated by recipe commit `56d7771a84ea378be09e66b7fc270cab29e17b0c`. The selected point is the upper tested boundary; no further A1 LR extension is authorized. |
...
one-A40 serial high-LR launch. None authorizes another launch. Future
definitive tranches remain serial by default unless a newly reviewed bounded
exception says otherwise. Multiple runners, same-GPU packing, heterogeneous
slots, and multi-Pod execution remain forbidden.
