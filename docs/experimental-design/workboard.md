...
| --- | --- | --- |
| A1 | ready | Reviewed eleven-cell design under `DESIGN-05`; configs/runs `001`–`008` remain immutable accepted inputs, and only configs `009`–`011` may be allocated before launch review. |
