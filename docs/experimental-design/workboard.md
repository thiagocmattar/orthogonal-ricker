...
| --- | --- | --- |
| A1 | running | All eight cells are completed, eligible, valid evidence; generate the complete curve and apply the preregistered eight-cell rule before freezing `lr_14m` |
