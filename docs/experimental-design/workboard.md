...
| --- | --- | --- |
| A1 | ready | The four-cell design is reviewed at `e8214a411afebf0cec5658f0f1ccdd3e6bcd5585`; the three original configs remain eligible, valid evidence, and only the `4e-3` cell must be materialized and launched before applying the selection rule |
