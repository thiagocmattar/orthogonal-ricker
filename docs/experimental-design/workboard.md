...
| `DESIGN-03` | in_progress | A1 final boundary extension | Review the exact five-cell A1 design while preserving configs/runs `001`–`004` and allocating only `8e-3` afterward | User direction on 2026-08-26; exact design SHA to be recorded in the reviewed manifest before config allocation |
