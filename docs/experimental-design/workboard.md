...
| `DESIGN-05` | in_progress | A1 very-high-LR extension | Review the exact eleven-cell A1 design while preserving configs/runs `001`–`008` and allocating only `1.28e-1`, `2.56e-1`, and `5.12e-1` afterward | Direct user direction on 2026-08-26; awaiting exact-SHA review of [`a1-very-high-lr-extension-review-packet.md`](a1-very-high-lr-extension-review-packet.md) |
...
| --- | --- | --- |
| A1 | blocked | Exact-SHA review of the proposed eleven-cell design under `DESIGN-05`; configs/runs `001`–`008` remain immutable accepted inputs and configs `009`–`011` are not yet allocated. |
