...
| --- | --- | --- |
| A1 | complete | All four cells are eligible, valid evidence; the predeclared rule selected `4e-3`, which remains the upper tested boundary at the fixed 400M-token horizon |
