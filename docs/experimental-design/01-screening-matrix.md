...
> Completed through `t4-rk-basin`: B3 materialized/completed is `32/40` /
> `32/40`. Next eligible tranche `t5-rk-shape` is not materialized; next
> unused prefix is `284`, and diagnostic `292` remains deferred.
