...
- Last completed scientific run: config `165`, fixed `G+` POST-RoPE Q/K at
  `kappa=0.30`, run `001-20260719-051008-59f8fe4c`, selection loss `7.03559`.
...
- Config `146` is the 128-step all-site A6-POST fixed-`G+`, `kappa=0.10`
  ...
  matched fixed `G+` POST-RoPE Q/K plus post-split V, `kappa=0.03` cell and is
  ready to launch.
