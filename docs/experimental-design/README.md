...
- Last completed run: config `141` A1-H at LR `1e-4`, run
  `001-20260718-231051-25bf322c`, result path
  `results/141-s1-b0-p14m-a1h-adamw-lr1em4-s0/001-20260718-231051-25bf322c`,
  selection loss `5.87474`.
- Config `134`, run `001-20260718-205354-8821b592`, completed the pooled
  exact-zero diagnostic over canonical configs `129--133`.
- Config `142` (A3, LR `1e-4`) is active pending local launch. Configs
  `143--144` are queued in the same LR-flank set.
...
- B0 has completed `17 / 22` scientific cells; 5 remain, of which 3 are
  executable and two post-PV context cells remain blocked. The declared S1
  core has completed `17 / 134` cells (`17 / 132` executable).
