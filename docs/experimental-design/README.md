...
- Current phase: E0.1 and all currently executable S1-B0 cells are complete;
  the fixed-gate engineering gate passed, and the first five S1-B1 cells plus
...
- Config `146` is the 128-step all-site A6-POST fixed-`G+`, `kappa=0.10`
  ...
  PRE-RoPE QKV, `kappa=0.30` cell; run `001-20260719-034439-ee5194a7` is
  active from clean commit `d9ad596`.
