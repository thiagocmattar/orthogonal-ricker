...
- Active run: config `132` A5-QK-PRE, run `001-20260718-200813-81b1dd63`,
  started `2026-07-18T20:08:13Z`, result path
  `results/132-s1-b0-p14m-a5qkpre-adamw-lr3em5-s0/001-20260718-200813-81b1dd63`.
  Expected terminal window is `2026-07-18T20:27--20:29Z`.
...
- Configs `129--133` materialize the next ordinary architecture-parent set:
  ...
  `132` (A5-QK-PRE) is running; config `133` remains queued.
