...
| --- | ---: | ---: |
| Pythia-14M | 262,144 tokens/update | `{5e-4, 1e-3, 2e-3}` |
...
| --- | --- | --- | ---: |
| A1 | 14M `A0`, three peak LRs, seed 0 | Freeze the lowest final selection-loss LR. | 3 |
...
proceed, the catalog contains 130–148 new pretraining runs (`K` from 1 to 4).
